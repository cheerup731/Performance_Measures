...
plot(tt$mse[-35], tt$msb_075[-35], pch = 20, xlab = 'MSE', ylab = 'msb_075', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
...
plot(tt$mse[-35], tt$msb_100[-35], pch = 20, xlab = 'MSE', ylab = 'msb_1', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
