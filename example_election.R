...
pop = election[,-1] # remove county 

colnames(pop) = c('y', 'x1', 'x2', 'x3', 'x4', 'x5', 'S_star')
...
sample.NP = pop[pop$S_star < 0.005, -ncol(pop)]
sample.NP$Z = 1
n_NP = nrow(sample.NP)
...
pdf("election.pdf", width = 12)
par(mfrow=c(2,4))

plot(tt$`error`, tt$cal1, pch = 20, xlab = 'error', ylab = 'Cal1', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal1, method = "kendall"), 2)),x = -30.65, y = 49150, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$cal2, pch = 20, xlab = 'error', ylab = 'Cal2', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal2, method = "kendall"), 2)), x = -30.65, y = -35.25, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$cal3, pch = 20, xlab = 'error', ylab = 'Cal3', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal3, method = "kendall"), 2)), x = -30.65, y = -35.25, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$msb_00, pch = 20, xlab = 'error', ylab = 'msb_0', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$msb_00, method = "kendall"), 2)), x = -30.65, y = -35.25, col = 'blue', cex = 1.5)
...
# text(paste("tau =", round(cor(tt$`error`, tt$msb_05, method = "kendall"), 2)), x = -30.65, y = -35.25, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$msb_10, pch = 20, xlab = 'error', ylab = 'msb_1', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$msb_10, method = "kendall"), 2)), x = -30.65, y = -35.25, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$entropy, pch = 20, xlab = 'error', ylab = 'MXE', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$entropy, method = "kendall"), 2)), x = -30.65, y = 0.60, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$brier, pch = 20, xlab = 'error', ylab = 'brier', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$brier, method = "kendall"), 2)), x = -30.65, y = 0.45, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$KS, pch = 20, xlab = 'error', ylab = 'KS', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$KS, method = "kendall"), 2)), x = -30.65, y = 0.345, col = 'blue', cex = 1.5)
