...
source("metrics.R")
library('xgboost'); library(spatstat.geom)
set.seed(14)

data("iris")

# the iris data
# Species == setosa as the inclusion of NP
# Sepal.Length as the target variable

pop = iris

colnames(pop) = c('y', 'x1', 'x2', 'x3', 'S_star')
...
sample.NP = pop[pop$S_star == "setosa", -ncol(pop)]
sample.NP$Z = 1
n_NP = nrow(sample.NP)
...
pdf("iris.pdf", width = 12)
par(mfrow=c(2,4))

plot(tt$`error`, tt$cal1, pch = 20, xlab = 'error', ylab = 'Cal1', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal1, method = "kendall"), 2)),x = -0.92, y = 3.68, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$cal2, pch = 20, xlab = 'error', ylab = 'Cal2', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal2, method = "kendall"), 2)), x = -0.92, y = -0.565, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$cal3, pch = 20, xlab = 'error', ylab = 'Cal3', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$cal3, method = "kendall"), 2)), x = -0.92, y = -0.565, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$msb_00, pch = 20, xlab = 'error', ylab = 'msb_0', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$msb_00, method = "kendall"), 2)), x = -0.92, y = -0.56, col = 'blue', cex = 1.5)
...
# text(paste("tau =", round(cor(tt$`error`, tt$msb_05, method = "kendall"), 2)), x = -0.92, y = -0.74, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$msb_10, pch = 20, xlab = 'error', ylab = 'msb_1', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$msb_10, method = "kendall"), 2)), x = -0.92, y = -0.96, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$entropy, pch = 20, xlab = 'error', ylab = 'MXE', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$entropy, method = "kendall"), 2)), x = -0.92, y = 0.6, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$brier, pch = 20, xlab = 'error', ylab = 'brier', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$brier, method = "kendall"), 2)), x = -0.92, y = 0.45, col = 'blue', cex = 1.5)

plot(tt$`error`, tt$KS, pch = 20, xlab = 'error', ylab = 'KS', cex = 1.5, cex.lab=1.5, cex.axis=1.5)
#text(paste("tau =", round(cor(tt$`error`, tt$KS, method = "kendall"), 2)), x = -0.92, y = 0.52, col = 'blue', cex = 1.5)
